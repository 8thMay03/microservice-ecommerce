    ...
    async function load() {
      ...
      try {
        const [detailRes, listRes] = await Promise.all([
          booksApi.get(id),
          booksApi.list({ page_size: 20 }),
        ]);
        if (cancelled) return;
        const b = normalizeBook(detailRes);
        setBook(b);
    ...
    return (
      <div className="min-h-screen flex flex-col bg-stone-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center px-4">
          ...
          <h1 className="font-serif text-2xl font-medium text-gray-900">Book not found</h1>
          <p className="text-gray-500">This book doesn&apos;t exist or may have been removed.</p>
          <Link to="/category/all" className="btn-primary mt-2">Browse all books</Link>
        </div>
        <Footer />
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-up animate-delay-1">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-7 xl:col-span-8 space-y-6">
              ...
              <div>
                <h2 className="font-serif text-lg font-semibold mb-3 text-gray-900">About this book</h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            <div className="max-w-3xl">
              ...
              <div className="bg-gray-50 rounded-2xl p-5 mb-8">
                <h3 className="text-sm font-semibold text-gray-900 mb-3">Rate this book</h3>
                {isAuthenticated ? (
                  ...
                  <p className="text-sm text-gray-500">
                    <Link to="/login" className="text-gray-900 font-medium hover:underline">Sign in</Link> to rate this book.
                  </p>
                )}
              </div>
          ...
          <section className="border-t border-gray-200 animate-fade-up animate-delay-4">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-5 gap-y-10">
                {relatedBooks.map((b) => (
                  <BookCard key={b.id} book={b} showRating={!!b.rating} />
                ))}
              </div>
            </div>
          </section>
